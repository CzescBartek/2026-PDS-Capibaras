...
x = df[['FEATURE_A',	'FEATURE_B_H',	'FEATURE_B_S',	'FEATURE_B_V',	'FEATURE_BORDER_COMPACTNESS',	'FEATURE_BORDER_CONVEXITY',	'Hair']]
y = df['Cancerous']
...
joblib.dump(final_model, '../result/models/KNN_Model_reduced.pkl')
...
plt.tight_layout()
plt.savefig('../result/figures/KNN_CM_ROC_reduced', dpi=300, bbox_inches='tight') 
plt.show()
plt.close() 